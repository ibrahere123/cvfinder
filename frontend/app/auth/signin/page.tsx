...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 flex flex-col p-6 md:p-12 bg-white order-2 md:order-1">
        ...
        <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full">
          ...
          <p className="text-gray-600 mb-8">Sign in to your account to continue finding the perfect candidates.</p>
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-teal-400 via-emerald-500 to-emerald-600 text-white p-12 relative overflow-hidden order-1 md:order-2">
